...
function getUrlParam(paraName) {
    var url = document.location.toString(); //http://localhost/pages/setmeal_detail.html?id=3&name=jack
    //alert(url);
    var arrObj = url.split("?");//http://localhost/pages/setmeal_detail.html    id=3&name=jack
    if (arrObj.length > 1) {
